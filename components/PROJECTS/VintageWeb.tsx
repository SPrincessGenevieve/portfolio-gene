  ...
  return (
    <div className="w-full h-full relative flex flex-col items-center justify-center">
      ...
      >
        ...
        <motion.div className="z-80 w-full flex items-center justify-center">
          <div
            className={`${
              screenWidth <= 1450
          ...
          >
            ...
            >
              <Image
                src={"/projects/web-vintage.png"}
                alt=""
                width={1000}
                height={900}
                className={` ${
                  screenWidth <= 1450
                    ? "w-full border-5 rounded-[10px] border-black "
                    : "w-[90vh] border-10 border-black"
                } shadow-blue-400 shadow-[0_0px_25px_rgba(59,130,246,0.5)] object-contain rounded-2xl`}
              ></Image>
            </motion.div>
            ...
            >
              ...
              >
                Built and maintained the web interface for a wine investment
                platform, focusing on responsive design, performance, and clear
              ...
              <div className="w-full flex justify-between items-center">
                ...
                <div className="flex gap-2 w-full justify-end">
                  <Image
                    alt=""
                    className="w-[5%] min-w-7 object-contain brightness-0 saturate-100 invert white hue-rotate-330"
                    width={400}
                    height={400}
                    src={"/stack/next.png"}
                  ></Image>
