...
export default function VintageMobile({ onClick }: { onClick?: () => void }) {
  ...
  return (
    <div className="w-full h-full relative flex flex-col items-center justify-center">
      <div className="z-80 w-[90%]  gap-8 p-4 flex flex-col">
        <div className="z-80 w-full flex items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src={"/projects/mob.png"}
                alt=""
                width={1000}
                height={1000}
                className={` ${
                  screenWidth <= 1450 ? "w-full]" : "w-[90vh]"
                } drop-shadow-[0px_0px_12px_rgba(81,162,255,0.5)] w-full rounded-2xl`}
              ></Image>
            </div>
            <div
